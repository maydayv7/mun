...
export default function Navbar() {
  ...
  <div className="w-full md:w-auto md:order-1 mt-2 md:flex" id="navbar-cta">
    <ul style={{ listStyleType: 'none' }} className="flex flex-col md:flex-row justify-center font-medium md:p-0  rounded-full bg-gray-50 md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
      ...
      <li>
        <NavLink to="/PreviousEditions" style={{ textDecoration: 'none',color }} className={`block py-2 px-3 md:p-0 rounded ${activeItem === 'Previous Editions' ? 'active' : ''}`} onClick={() => setActiveItem('Previous Editions')}>Previous Editions</NavLink>
      </li>
      {/* <li>
          <NavLink to="/Service"
          style={{textDecoration:'none'}} className={`block py-2 px-3 md:p-0 rounded ${activeItem === 'Services' ? 'active' : ''}`} onClick={() => setActiveItem('Services')}>Services</NavLink>
      ...
      <li>
        <NavLink to="/ContactUs" style={{ textDecoration: 'none' }} className={`block py-2 px-3 md:p-0 rounded ${activeItem === 'Contact' ? 'active' : ''}`} onClick={() => setActiveItem('Contact')}>Contact</NavLink>
      </li>
    </ul>
  </div>
</div>
