...
const Details = ({name,position,socialMedia}) => {
    return ( 
        <div className="text-left ml-2 mt-4 overflow-hidden w-full mr-10">
            <p className="text-xl lg:text-3xl font-extrabold font-raleway m-0 text-[#60E1A4] hyphens-auto">{name}</p>
            <p className="text-lg lg:text-xl text-grey font-light tracking-wider m-0 text-[#60e1a5ca] hyphens-auto">{position}</p>
